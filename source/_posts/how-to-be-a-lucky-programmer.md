...
How can we apply this to programming? How can you be a lucky programmer? <figure>![](/uploads/2017/01/image-1.png "How to be a Lucky Programmer") Photo [Gaertringen](//visualhunt.com/p/gaertringen/) via [Visual Hunt](//visualhunt.com/)</figure>
...
Body language is a great place to start. You’ve probably seen the Amy Cudy video where she talks about power poses. But body language goes much further than power poses. But let’s start there. 
...
For more about how to use LinkedIn, check out my article, “[LinkedIn Tips for Programmers](/linkedin-tips-for-programmers/)”
